---
{"dg-publish":true,"permalink":"/platforms/hal/","tags":["icm/uses"],"dg-note-properties":{"name":"HAL","aliases":["Hyper Articles en Ligne","HAL open archive","HAL-CNRS","HAL-Inserm"],"website":"https://hal.science","type":"repository","scope":"french","domain":["multimodal"],"status":"active","founded":2001,"parent_org":"CCSD (Centre pour la Communication Scientifique Directe) / CNRS","tags":["icm/uses"]}}
---
...
- **[[Governance/ANR Open Science Policy\|ANR Open Science Policy]]** — requires immediate open access deposit in HAL or discipline-specific repository for all ANR-funded publications from 2022
- **[[Governance/CNRS Open Science\|CNRS Open Science]]** — institutional mandate for all CNRS-affiliated researchers to deposit in HAL
- **[[Governance/Inserm Open Science\|Inserm Open Science]]** — institutional mandate for all Inserm researchers
- **Horizon Europe** — EU open access mandate; HAL deposits satisfy EU compliance via [[Platforms/OpenAIRE\|OpenAIRE]] harvesting

## HAL and the French Open Science Infrastructure
HAL is the publication layer of the French open science stack:
- Publications → HAL (open access mandate)
- Research data → [[Platforms/Recherche Data Gouv\|Recherche Data Gouv]] (data mandate)
- Software code → [[Platforms/Software Heritage\|Software Heritage]] (software mandate)
- DMPs → [[Platforms/OPIDoR\|OPIDoR]] (DMP mandate)
...
- European integration: [[Platforms/OpenAIRE\|OpenAIRE]] (HAL metadata harvested for EU OA compliance)
- Part of: [[Platforms/data.gouv.fr\|data.gouv.fr]] ecosystem (publications layer)
...
## Resources
- https://hal.science
- https://hal.science/ICM (HAL-ICM portal)
- https://www.ccsd.cnrs.fr (CCSD — HAL operator)
