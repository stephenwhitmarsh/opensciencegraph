---
{"dg-publish":true,"permalink":"/platforms/nif/","dg-note-properties":{"name":"Neuroscience Information Framework","aliases":["NIF"],"website":"https://neuinfo.org","type":"platform","scope":"international","domain":["neuroimaging","multimodal"],"status":"active","founded":2008,"parent_org":"UCSD / NIH Blueprint for Neuroscience Research"}}
---
...
NIF's most widely used product is the **RRID** (Research Resource Identifier) system, which is now mandated by hundreds of journals for citing antibodies, cell lines, model organisms, software tools, and databases in Methods sections.
