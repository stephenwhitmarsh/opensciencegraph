---
{"dg-publish":true,"permalink":"/platforms/vivli/","dg-note-properties":{"name":"VIVLI","aliases":["Center for Global Clinical Research Data"],"website":"https://vivli.org","type":"platform","scope":"international","domain":["clinical"],"status":"active","founded":2016}}
---
...
## Data Standards
- **[[Standards/CDISC\|CDISC]]** — VIVLI encourages SDTM/ADaM-formatted submissions; provides metadata harmonisation support for non-CDISC datasets
- **[[Standards/OMOP CDM\|OMOP CDM]]** — VIVLI is exploring OMOP harmonisation for federated queries across deposited datasets
- Metadata uses controlled terminology ([[Standards/MeSH\|MeSH]] for conditions, [[Standards/RxNorm\|RxNorm]] for drugs)
...
## Connections
- Standards: [[Standards/CDISC\|CDISC]] (SDTM/ADaM), [[Standards/OMOP CDM\|OMOP CDM]], [[Standards/MeSH\|MeSH]], [[Standards/RxNorm\|RxNorm]]
- Related platforms: [[Governance/YODA Project\|YODA Project]] (Yale-based IPD sharing), [[Governance/TransCelerate\|TransCelerate]] (pharma industry data standardisation)
- Trial registry: [[Platforms/ClinicalTrials.gov\|ClinicalTrials.gov]] (linked trial registration)
- Relevant to: [[Actors/Paris Brain Institute\|Paris Brain Institute]] (access to neurological disease trial IPD for meta-analysis and replication)
