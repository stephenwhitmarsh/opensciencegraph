...
- Data exchange: [[Standards/HL7 FHIR\|HL7 FHIR]] integration (in development)
...
## Connections
- Primary institutional user: [[Governance/AP-HP\|AP-HP]] (contracted since 2003; standard eCRF for AP-HP DRCD)
- Clinical research context: [[Governance/ECRIN\|ECRIN]] (European network uses compatible eCRF standards)
- Standards: [[Standards/CDISC\|CDISC]] (CDASH/SDTM), [[Standards/MedDRA\|MedDRA]] (adverse event coding)
- Comparable tools: [[Platforms/REDCap\|REDCap]] (research/academic), CleanWEB (regulatory-grade trials)
- French governance: [[Governance/Code de la Sante Publique\|Code de la Sante Publique]], CNIL, [[Governance/ANS\|ANS]]
- Relevant to [[Actors/Paris Brain Institute\|Paris Brain Institute]]: used widely across AP-HP-sponsored clinical trials; context for understanding the French clinical research eCRF ecosystem alongside [[Platforms/REDCap\|REDCap]]
