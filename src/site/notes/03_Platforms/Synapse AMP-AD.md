...
- Data types: bulk RNA-seq, scRNA-seq, spatial transcriptomics, proteomics, methylation, ATAC-seq; all in [[02_Standards/AnnData\|AnnData]] / h5ad or standard formats

### CommonMind Consortium (CMC)
Lead site: [[01_Actors/Mount Sinai Neuroscience\|Mount Sinai Neuroscience]]. Brain transcriptomics and epigenomics from schizophrenia, bipolar disorder, and ALS postmortem brain tissue. Formats: RNA-seq counts, ATAC-seq peaks, Hi-C contact matrices; metadata via [[03_Platforms/NCBI GEO\|NCBI GEO]] cross-links.

### PsychENCODE
Lead sites include [[01_Actors/Mount Sinai Neuroscience\|Mount Sinai Neuroscience]] and multiple US institutions. Multi-omics atlas of the human brain across psychiatric disorders and developmental stages. All data deposited to Synapse under controlled access aligned with [[03_Platforms/dbGaP\|dbGaP]].
...
## Relevance to ICM
Synapse / AMP-AD hosts the largest publicly available collection of human brain RNA-seq and multiomics data — directly accessible to [[01_Actors/DAC\|DAC]] and [[01_Actors/iGENSEQ\|iGENSEQ]] at ICM for benchmarking RNA-seq pipelines against large reference datasets, integrating ICM neurological disease cohort data with AMP-AD Alzheimer's multiomics, and accessing CommonMind / PsychENCODE psychiatric brain transcriptomics for comparison with ICM psychiatric genomics data.
...
- Lead data contributors: [[01_Actors/Mount Sinai Neuroscience\|Mount Sinai Neuroscience]], Mayo Clinic, Rush University, multiple US academic centres
- Standards: [[02_Standards/AnnData\|AnnData]], [[02_Standards/VCF\|VCF]], standard bioinformatics formats
- Related repositories: [[03_Platforms/NCBI GEO\|NCBI GEO]] (cross-linked metadata), [[03_Platforms/dbGaP\|dbGaP]] (controlled access companion), [[03_Platforms/EGA\|EGA]] (European controlled-access equivalent)
