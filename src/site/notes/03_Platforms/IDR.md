...
## Overview
The Image Data Resource (IDR) is a public repository for reference image datasets from published scientific studies, hosted at EMBL-EBI and built on [[01_Actors/OME\|OME]] infrastructure (OMERO). IDR serves as the primary open-access repository for biological microscopy and biomedical imaging data, analogous to what [[03_Platforms/OpenNeuro\|OpenNeuro]] is for neuroimaging — a curated, FAIR-compliant public archive of imaging datasets associated with peer-reviewed publications.
...
All datasets are linked to their source publications and curated with structured metadata following [[02_Standards/REMBI\|REMBI]] (Recommended Metadata for Biological Images) and [[02_Standards/OME File Formats\|OME File Formats]] standards.

## Technical Infrastructure
IDR runs on [[01_Actors/OME\|OME]]'s OMERO platform, providing programmatic access via OMERO Python/Java/R APIs, web-based image browsing and annotation, integration with Jupyter notebooks for remote analysis, metadata in [[02_Standards/OME File Formats\|OME File Formats]] (OME-TIFF, OME-Zarr) for interoperability, and DOI assignment via EMBL-EBI data submission system.
