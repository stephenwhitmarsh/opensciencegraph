...
intermediate analysis phases to public release in repositories such as [[03_Platforms/Recherche Data Gouv\|Recherche Data Gouv]], [[03_Platforms/EBRAINS\|EBRAINS]], [[03_Platforms/OpenNeuro\|OpenNeuro]], or international archives (EGA, NCBI GEO, ENA).
...
- **IS1 (multi-omics + imaging integration)** — directly addresses the challenge of combining neuroimaging data ([[02_Standards/BIDS\|BIDS]] / [[04_Governance/CATI\|CATI]]) with genomics ([[01_Actors/iGENSEQ\|iGENSEQ]]) and clinical data ([[02_Standards/OMOP CDM\|OMOP CDM]]) in a FAIR-compliant framework
- **IS3 (health data)** — interfaces with [[04_Governance/Health Data Hub\|Health Data Hub]] and [[04_Governance/EHDS\|EHDS]] secondary use infrastructure
...
- Data-producing infrastructure partners: France Génomique, [[04_Governance/France BioImaging\|France BioImaging]], [[04_Governance/France Life Imaging\|France Life Imaging]], EMBRC France, and others
