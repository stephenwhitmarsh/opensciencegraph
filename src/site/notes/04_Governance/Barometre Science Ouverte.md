...
- Breakdown by access type: gold (publisher OA), green (repository deposit in [[04_Governance/HAL\|HAL]]), hybrid, bronze
...
The BSO uses **Unpaywall** and **OpenAlex** for publication open access status, **[[04_Governance/HAL\|HAL]]** metadata for French repository deposits, **DOI** resolution for publication identification, and **[[02_Standards/DCAT\|DCAT]]** / **[[02_Standards/Dublin Core\|Dublin Core]]** for dataset metadata. All source code: https://github.com/MinistereSupRecherche/bso.
...
- Measures: [[04_Governance/HAL\|HAL]] (publication deposits), [[03_Platforms/Recherche Data Gouv\|Recherche Data Gouv]] (data), [[04_Governance/Ouvrir la Science\|Ouvrir la Science]] (policy compliance)
...
- Relevant to: [[01_Actors/Paris Brain Institute\|Paris Brain Institute]] (ICM open access rate tracked; Sorbonne Université BSO3 covers ICM publications)
