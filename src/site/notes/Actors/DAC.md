...
![DAC.png\|400](/img/user/Actors/DAC.png)
# DAC — Data Analysis Core

## Overview
The Data Analysis Core (DAC) is [[Actors/Paris Brain Institute\|Paris Brain Institute]] (ICM)'s bioinformatics and statistical analysis support platform, one of [[Actors/Paris Brain Institute\|ICM]]'s 10 core technological platforms. It provides computational expertise, analysis pipelines, training, and consultation to [[Actors/Paris Brain Institute\|ICM]] research teams and external collaborators, bridging the gap between data production (at platforms like [[Actors/iGENSEQ\|iGENSEQ]], [[Actors/CENIR\|CENIR]], and [[Actors/Banque ADN et Cellules\|Banque ADN et Cellules]]) and publication-ready scientific outputs.

The DAC is staffed by bioinformaticians, statisticians, and data scientists who work embedded in or in close collaboration with [[Actors/Paris Brain Institute\|ICM]] research teams. It implements [[Governance/FAIR Principles\|FAIR Principles]] in [[Actors/Paris Brain Institute\|ICM]] data management workflows and serves as the primary interface between [[Actors/Paris Brain Institute\|ICM]] and national infrastructure providers [[Governance/IFB\|IFB]] and [[Platforms/OPIDoR\|OPIDoR]].

## Divisions and Services

The DAC is organised into four divisions serving both internal [[Actors/Paris Brain Institute\|ICM]] teams and external biomedical research projects, on a fee-for-service.
...
- **DEJAVU** — [[Actors/Paris Brain Institute\|ICM]]-internal tool aggregating exome/genome short variants from ~3,000 [[Actors/Paris Brain Institute\|ICM]] project samples
...
- Develops and implements [[Actors/Paris Brain Institute\|ICM]]'s data management policy
...
- Tools covered: Git, OMERO+, [[Platforms/REDCap\|REDCap]], Tumorotek, [[Platforms/OPIDoR\|OPIDoR]]
...
DAC activities run on [[Actors/Paris Brain Institute\|ICM]] IT-managed high-performance computing equipment:
...
## Open Science Role
The DAC is [[Actors/Paris Brain Institute\|ICM]]'s primary interface with the French and European open science infrastructure:
...
- [[Platforms/OPIDoR\|OPIDoR]] — DAC provides DMP training and support using [[Platforms/OPIDoR\|OPIDoR]] tools
- [[Governance/FAIR Principles\|FAIR Principles]] — the Data Management division implements FAIR data management across [[Actors/Paris Brain Institute\|ICM]] through databases, data models, and policy development
...
- DMP tools: [[Platforms/OPIDoR\|OPIDoR]]
