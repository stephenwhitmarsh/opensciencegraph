---
{"dg-publish":true,"permalink":"/governance/co-so/","tags":["icm/participates"],"dg-note-properties":{"name":"Comite pour la Science Ouverte","aliases":["CoSO","Comité pour la Science Ouverte"],"website":"https://www.ouvrirlascience.fr/le-comite-pour-la-science-ouverte/","type":"working-group","scope":"french","domain":["multimodal"],"status":"active","founded":2018,"parent_org":"Ministere de l'Enseignement Superieur et de la Recherche","tags":["icm/participates"]}}
---
...
- **FNSO calls for projects** — CoSO manages the National Fund for Open Science (FNSO), funding diamond OA journals, open software, and open science training initiatives
- **Open science barometer guidance** — CoSO coordinates with [[Governance/Barometre Science Ouverte\|Barometre Science Ouverte]] for monitoring
- **EOSC engagement** — CoSO coordinates French participation in [[Governance/EOSC\|EOSC]] governance and service development

## Membership
CoSO includes representatives from MESR (Ministry — secretariat), CNRS, Inserm, IRD, INRAE, INRIA, CEA, IFREMER (major research organisations), ANR (national research agency), France Universités (CPU — university network), CDEFI (engineering school network), RENATER (national research network), [[Governance/IFB\|IFB]] and CCSD (HAL operator — infrastructure operators). [[Actors/Paris Brain Institute\|Paris Brain Institute]] participates in CoSO activities through its parent organisations CNRS and Inserm.
