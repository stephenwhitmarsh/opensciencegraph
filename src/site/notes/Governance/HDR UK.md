---
{"dg-publish":true,"permalink":"/governance/hdr-uk/","dg-note-properties":{"name":"HDR UK","aliases":["Health Data Research UK"],"website":"https://www.hdruk.ac.uk","type":"infrastructure","scope":"international","domain":["health","clinical","genomics"],"status":"active","founded":2018,"parent_org":"UKRI / DHSC / Wellcome Trust / BHF / Cancer Research UK"}}
---
...
### HDRUK Gateway
The **HDR UK Innovation Gateway** (https://healthdatagateway.org) is a national data catalogue providing a unified discovery layer for UK health datasets — NHS electronic health records, biobanks, cohort studies, and clinical trial data. Datasets are described with standardised metadata aligned with [[Standards/DCAT\|DCAT]] and FAIR principles. The Gateway supports discovery of data assets held by NHS Digital, [[Actors/UK Biobank\|UK Biobank]], SAIL Databank, and hundreds of other data custodians.
...
HDR UK coordinates the **UK Health Data Research Alliance**, a network of NHS organisations, research institutes, and charities committed to FAIR health data sharing. Members include [[Actors/UK DRI\|UK DRI]], NHS Digital, UK Biobank, and others. A major GSK / HDR UK / UK DRI collaboration on NHS-scale population data for dementia risk research was announced in 2025.

### TRE (Trusted Research Environments)
HDR UK promotes and standardises **Trusted Research Environments** (TREs) as the secure infrastructure model for accessing sensitive NHS health data, aligning with [[Governance/EHDS\|EHDS]] secondary use frameworks and [[Actors/GA4GH\|GA4GH]] data access standards.

## FAIR and Open Science Alignment
HDR UK implements [[Governance/FAIR Principles\|FAIR Principles]] across its programmes:
- DCAT-aligned metadata for the Gateway catalogue
- [[Standards/OMOP CDM\|OMOP CDM]] as the recommended common data model for NHS research data
- [[Standards/HL7 FHIR\|HL7 FHIR]] for data exchange and EHR interoperability
