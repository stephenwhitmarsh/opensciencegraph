---
{"dg-publish":true,"permalink":"/governance/ec-open-science-policy/","dg-note-properties":{"name":"European Commission Open Science Policy","aliases":["EC Open Science","European Open Science Policy"],"website":"https://research-and-innovation.ec.europa.eu/strategy/strategy-research-and-innovation/our-digital-future/open-science_en","type":"policy","scope":"european","domain":["multimodal"],"status":"active","founded":2016,"parent_org":"European Commission — DG Research and Innovation (DG RTD)"}}
---
...
## Overview
The European Commission's open science policy is the overarching EU framework mandating open access, FAIR data, and open science practices for all EU-funded research. Implemented through DG Research and Innovation (DG RTD), it provides the policy foundation for the [[Governance/EOSC\|EOSC]] ecosystem, shapes Horizon Europe grant conditions, and drives the [[Governance/EHDS\|EHDS]] regulatory framework.
...
French open science policy ([[Governance/Ouvrir la Science\|Ouvrir la Science]], [[Governance/ANR Open Science Policy\|ANR Open Science Policy]]) is explicitly aligned with EC open science requirements: ANR mandates mirror Horizon Europe DMP and OA requirements; [[Governance/CoSO\|CoSO]] coordinates French implementation of EC policy commitments; [[Platforms/Recherche Data Gouv\|Recherche Data Gouv]] is France's contribution to the EOSC data space.

## Connections
- Implements: [[Governance/EOSC\|EOSC]], cOAlition S / Plan S
