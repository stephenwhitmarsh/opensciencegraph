...
- **Horizon Europe** — EU open access mandate; HAL deposits satisfy EU compliance via [[Governance/OpenAIRE\|OpenAIRE]] harvesting
...
- Research data → Recherche Data Gouv (data mandate)
- Software code → Software Heritage (software mandate)
- DMPs → OPIDoR (DMP mandate)
