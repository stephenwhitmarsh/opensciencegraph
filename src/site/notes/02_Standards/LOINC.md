...
## Overview
LOINC is the universal standard for identifying medical laboratory tests,
clinical observations, outcomes measures, imaging studies, and clinical
documents. Developed by the Regenstrief Institute (Indiana University), LOINC
...
## Key Uses for ICM
- **CSF and blood biomarkers** — amyloid-β 42/40, phospho-tau 181, NfL
  (neurofilament light chain) used in Alzheimer's and neurodegeneration research
- **Imaging reports** — MRI and PET report coding
- **Clinical scales** — MMSE (Mini-Mental State Examination), MoCA (Montreal
  Cognitive Assessment), UPDRS (Parkinson's rating scale)
...
- **[[02_Standards/OMOP CDM\|OMOP CDM]]** — LOINC is one of the core standard vocabularies for
  measurement and observation concepts; AP-HP EDS uses LOINC extensively
