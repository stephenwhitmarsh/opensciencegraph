...
- **[[02_Standards/BIDS\|BIDS]]** — the `task` metadata field in BIDS datasets can reference Cognitive Atlas task identifiers, enabling formal semantic task description
- **[[03_Platforms/NeuroVault\|NeuroVault]]** — requires Cognitive Atlas task annotation for all uploaded statistical maps; powers the Neurosynth integration
...
## Connections
- Used with: [[02_Standards/BIDS\|BIDS]] (task annotation), [[03_Platforms/NeuroVault\|NeuroVault]] (required annotation), [[03_Platforms/OpenNeuro\|OpenNeuro]] (fMRI datasets)
