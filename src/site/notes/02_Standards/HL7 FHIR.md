...
- **[[04_Governance/Health Data Hub\|Health Data Hub]]** uses FHIR as part of its interoperability framework alongside [[02_Standards/OMOP CDM\|OMOP CDM]] for secondary data use
...
- ETL pipelines convert FHIR resources to OMOP tables (OHDSI provides FHIR-to-OMOP mapping tools); [[04_Governance/EHDS\|EHDS]] mandates both standards for primary and secondary use respectively

## Connections
- Maps to: [[02_Standards/OMOP CDM\|OMOP CDM]] (ETL pathway), [[02_Standards/openEHR\|openEHR]] (bidirectional mapping), [[02_Standards/DICOM\|DICOM]] (ImagingStudy resource), [[02_Standards/CDISC\|CDISC]] (ResearchStudy / clinical trial data)
...
- Relevant to: [[01_Actors/Paris Brain Institute\|Paris Brain Institute]] (AP-HP EDS FHIR access, EHDS compliance, clinical trial data integration)
