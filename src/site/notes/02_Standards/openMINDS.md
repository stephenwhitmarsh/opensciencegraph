---
{"dg-publish":true,"permalink":"/02-standards/open-minds/","tags":["icm/uses"],"dg-note-properties":{"name":"Open Metadata Initiative for Neuroscience Data Structures","aliases":["openMINDS"],"website":"https://openminds.ebrains.eu","type":"framework","scope":"european","domain":["neuroimaging","multimodal"],"status":"active","founded":2020,"parent_org":"EBRAINS / Human Brain Project","tags":["icm/uses"],"icon":"https://openminds.ebrains.eu/favicon.ico"}}
---
...
- **I** — uses [[02_Standards/UBERON\|UBERON]], [[02_Standards/BIDS\|BIDS]] conventions, and linked data (JSON-LD)
