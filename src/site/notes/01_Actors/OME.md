...
## Overview
The Open Microscopy Environment is a consortium of universities, research laboratories, industry partners, and developers producing open-source software and data format standards for biological microscopy. Founded in 2001 by Jason Swedlow, Ilya Goldberg, and Peter Sorger, OME is to microscopy what [[01_Actors/INCF\|INCF]] is to neuroscience informatics — the central community body that defines how imaging data is formatted, stored, and shared. Its products underpin the data infrastructure of [[04_Governance/Euro-BioImaging\|Euro-BioImaging]], [[04_Governance/France BioImaging\|France BioImaging]], and all major bioimaging repositories. Core development is led by the University of Dundee and German BioImaging.

## Standards Produced
- [[02_Standards/OME File Formats\|OME File Formats]] — the OME file format family: OME-TIFF (metadata-rich TIFF) and OME-Zarr (cloud-native next-generation format)
...
- Deployed by: [[04_Governance/Euro-BioImaging\|Euro-BioImaging]] (OMERO at all nodes), [[04_Governance/France BioImaging\|France BioImaging]] (OMERO instances)
- Endorsed by: [[04_Governance/ELIXIR\|ELIXIR]], [[04_Governance/EOSC\|EOSC]]
- Integrates with: [[04_Governance/QUAREP-LiMi\|QUAREP-LiMi]] (metadata and QC standards), [[02_Standards/REMBI\|REMBI]] (metadata framework), BioImage Archive (EMBL-EBI)
- Related: [[01_Actors/INCF\|INCF]] (equivalent body for neuroscience data standards), [[02_Standards/NIfTI\|NIfTI]] (analogous role for MRI data)
