---
{"dg-publish":true,"permalink":"/standards/ann-data/","dg-note-properties":{"name":"AnnData","aliases":["h5ad","AnnData format","Annotated Data"],"website":"https://anndata.readthedocs.io","type":"standard","scope":"international","domain":["genomics","multimodal"],"status":"active","founded":2017,"parent_org":"Theislab / Helmholtz Munich / Broad Institute"}}
---
...
For [[Actors/Paris Brain Institute\|Paris Brain Institute]], AnnData/h5ad is the primary output format of [[Actors/iGENSEQ\|iGENSEQ]]'s single-cell RNA-seq workflows (10x Genomics, Visium spatial transcriptomics) and is directly relevant to neurological disease cell atlas studies using [[Actors/BICAN\|BICAN]] reference data.
...
- [[Standards/BIDS\|BIDS]] Microscopy extension (BEP031) is developing alignment with AnnData for BIDS-compatible spatial transcriptomics datasets

## CELLxGENE and [[Actors/BICAN\|BICAN]] Alignment
- **CELLxGENE Data Portal** (https://cellxgene.cziscience.com) — the largest public single-cell dataset collection; all datasets in h5ad format with standardised [[Standards/Cell Ontology\|Cell Ontology]] (CL) and [[Standards/UBERON\|UBERON]] annotations
- **[[Actors/BICAN\|BICAN]]** — BRAIN Initiative cell atlas data distributed in h5ad via NeMO Archive and AWS Open Data
...
- Used by: [[Actors/BICAN\|BICAN]], CELLxGENE, Human Cell Atlas, [[Actors/iGENSEQ\|iGENSEQ]] workflows
- Annotations use: [[Standards/Cell Ontology\|Cell Ontology]] (cell types), [[Standards/UBERON\|UBERON]] (anatomy), [[Standards/HPO\|HPO]] / [[Standards/MONDO\|MONDO]] (disease context)
- Related format: [[Standards/NWB\|NWB]] (analogous role for electrophysiology)
- Spatial integration: [[Standards/BIDS\|BIDS]] Microscopy BEP031 (emerging alignment)
- Relevant to: [[Actors/Paris Brain Institute\|Paris Brain Institute]] (scRNA-seq and spatial transcriptomics outputs from [[Actors/iGENSEQ\|iGENSEQ]]; [[Actors/BICAN\|BICAN]] reference data access)
