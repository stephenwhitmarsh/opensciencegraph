...
ATC is a standardised vocabulary in the [[Standards/OMOP CDM\|OMOP CDM]] Athena vocabulary browser, where it supplements [[Standards/RxNorm\|RxNorm]] as a drug classification hierarchy. ATC codes are used for:
