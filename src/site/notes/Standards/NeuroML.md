---
{"dg-publish":true,"permalink":"/standards/neuro-ml/","dg-note-properties":{"name":"Neural Open Markup Language","aliases":["NeuroML","NeuroML2"],"website":"https://neuroml.org","type":"standard","scope":"international","domain":["computational","electrophysiology"],"status":"active","founded":2001,"parent_org":"INCF"}}
---
...
- Complements: [[Standards/NWB\|NWB]] (experimental data), [[Standards/BIDS\|BIDS]] (dataset organisation)
- Archived on: Open Source Brain, ModelDB
- Related standards: NineML (network-level modelling language)
- Relevant to: [[Platforms/EBRAINS\|EBRAINS]] (Blue Brain Project models)
