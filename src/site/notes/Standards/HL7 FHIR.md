...
globally and is mandated by the [[Governance/EHDS\|EHDS]] for European health data spaces, by the
...
- **[[Governance/Health Data Hub\|Health Data Hub]]** uses FHIR as part of its interoperability framework alongside
  [[Standards/OMOP CDM\|OMOP CDM]] for secondary data use
...
- ETL pipelines convert FHIR resources to OMOP tables (OHDSI provides FHIR-to-OMOP
  mapping tools); [[Governance/EHDS\|EHDS]] mandates both standards for primary and secondary use respectively

## Connections
- Maps to: [[Standards/OMOP CDM\|OMOP CDM]] (ETL pathway), [[Standards/openEHR\|openEHR]] (bidirectional mapping),
  [[Standards/DICOM\|DICOM]] (ImagingStudy resource), [[Standards/CDISC\|CDISC]] (ResearchStudy / clinical trial data)
...
- Relevant to: [[Actors/Paris Brain Institute\|Paris Brain Institute]] (AP-HP EDS FHIR access, EHDS compliance,
