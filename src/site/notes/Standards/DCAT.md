...
- **[[Governance/data.gouv.fr\|data.gouv.fr]]** — uses DCAT for all government open data catalogue entries
- **[[Governance/Health Data Hub\|Health Data Hub]]** — catalogue of health datasets uses DCAT-AP
...
- Used by: [[Platforms/Recherche Data Gouv\|Recherche Data Gouv]], [[Governance/EOSC\|EOSC]], [[Governance/data.gouv.fr\|data.gouv.fr]], [[Governance/Health Data Hub\|Health Data Hub]]
- Complements: Dublin Core (simpler metadata), [[Standards/PROV-O\|PROV-O]] (provenance)
- Related: [[Governance/OPIDoR\|OPIDoR]] (DMP tools produce DCAT-compatible metadata)
