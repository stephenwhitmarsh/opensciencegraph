...
```
NIfTI is the pivot format: produced from [[Standards/DICOM\|DICOM]], consumed by analysis tools, and organised by [[Standards/BIDS\|BIDS]]. The [[Standards/BIDS\|BIDS]] specification mandates NIfTI as the required image format for MRI and PET data.
